...
cmds.ikHandle(n='arm_ikHandle',sj='shoulder_ik_JNT',ee='wrist_ik_JNT',sol='ikRPsolver',p=2,w=1)
...
#create ik controls
pos = cmds.xform('wrist_ik_JNT',q=True,t=True,r=True,ws=True)
...
#create fk controls
pos = cmds.xform('wrist_fk_JNT',q=True,t=True,r=True,ws=True)
...
pos = cmds.xform('elbow_fk_JNT',q=True,t=True,r=True,ws=True)
...
pos = cmds.xform('shoulder_fk_JNT',q=True,t=True,r=True,ws=True)
...
#grouping fk controls
cmds.parent('wrist_fk_CTRL_NUL','elbow_fk_CTRL')
cmds.parent('elbow_fk_CTRL_NUL','shoulder_fk_CTRL')

cmds.select(cl=True)

#parentConstraint ik and fk to bind joints
cmds.parentConstraint('elbow_fk_JNT','elbow_ik_JNT','elbow_JNT',mo=0)
cmds.parentConstraint('wrist_fk_JNT','wrist_ik_JNT','wrist_JNT',mo=0)
cmds.parentConstraint('shoulder_fk_JNT','shoulder_ik_JNT','shoulder_JNT',mo=0)
